...
{{- define "looker.generateLookerInternalSecrets" }}
    ...
    lookerLicenseKey: {{ include "harnesscommon.secrets.passwords.manage" (dict "secret" "looker-secrets" "key" "lookerLicenseKey" "providedValues" (list "secrets.lookerLicenseKey" "secrets.default.LICENSE_KEY") "length" 10 "context" .) }}
    {{- end }}
    ...
    {{- $hasAtleastOneSecret = true }}
    lookerLicenseFile: {{ include "harnesscommon.secrets.passwords.manage" (dict "secret" "looker-secrets" "key" "lookerLicenseFile" "providedValues" (list "secrets.lookerLicenseFile" "secrets.default.LICENSE_FILE") "length" 10 "context" .) }}
    {{- end }}
    {{- end }}
