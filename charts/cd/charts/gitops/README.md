...
![Version: 0.8.0](https://img.shields.io/badge/Version-0.8.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.75.5](https://img.shields.io/badge/AppVersion-v0.75.5-informational?style=flat-square)
...
| agentDockerImage.image.tag | string | `"v0.56.5"`                                                                          |  |
